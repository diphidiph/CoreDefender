...
public class BuildOverlayView {
    ...
    public BuildOverlayView() {
        ...
        // Test of JavaFX je PNG kan vinden
        URL test = getClass().getResource("/be/iiw/coredefender/Buildings_Images/GoldStash_Level_1.svg");
        System.out.println("GoldStash svg gevonden: " + test);
        ...
        GoldStashButton = createButtonWithImage("/be/iiw/coredefender/Buildings_Images/GoldStash_Level_1.svg");
    ...
    private Button createButton(String svgData) {
     ...
     private Button createButtonWithImage(String imagePath) {
        ...
        imgView.setFitWidth(72);   // breedte van knop
        imgView.setFitHeight(72);  // hoogte van knop
